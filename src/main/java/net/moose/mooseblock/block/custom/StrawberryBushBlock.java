...
public class StrawberryBushBlock extends PlantBlock implements Fertilizable{
    ...
    private static final VoxelShape SMALL_SHAPE = Block.createCuboidShape(3.0, 0.0, 3.0, 13.0, 6.0, 13.0);
    private static final VoxelShape LARGE_SHAPE = Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 10.0, 15.0);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            StrawberryBushBlock.dropStack(world, pos, new ItemStack(ModItems.STRAWBERRY, j + (bl ? 1 : 0)));
