...
public class ModParticles {
    ...
    public static final DefaultParticleType ILL_ROSE_PARTICLE = FabricParticleTypes.simple();
    ...
    public static void registerModParticles() {
        ...
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(mooseblock.MOD_ID, "sparkle_particle"),
                SPARKLE_PARTICLE);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(mooseblock.MOD_ID, "ill_rose_particle"),
                ILL_ROSE_PARTICLE);
    }
